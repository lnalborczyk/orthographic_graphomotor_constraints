...
```{r posterior-stops, echo = FALSE, eval = TRUE, out.width = "100%", fig.width = 9, fig.height = 6, fig.cap = "Effect of word frequency on the number of stops for each grade (in column) and letter (in row). The histogram contains posterior samples for each effect, where the posterior distribution is summarised by its mean and 95\\% highest density interval (HDI). The green text indicates the probability that the parameter values is either inferior or superior to 0."}
###############################################################
# Computing the effect of frequency for each letter and Grade #
###############################################################
...
```{r posterior-velocity, echo = FALSE, eval = TRUE, out.width = "100%", fig.width = 9, fig.height = 6, fig.cap = "Effect of word frequency on the mean velocity (in mm per second) for each grade (in column) and letter (in row). The histogram contains posterior samples for each effect, where the posterior distribution is summarised by its mean and 95\\% highest density interval (HDI). The green text indicates the probability that the parameter values is either inferior or superior to 0."}
###############################################################
# Computing the effect of frequency for each letter and Grade #
###############################################################
...
```{r posterior-size, echo = FALSE, eval = TRUE, out.width = "100%", fig.width = 9, fig.height = 6, fig.cap = "Effect of word frequency on the letter size (in mm) for each grade (in column) and letter (in row). The histogram contains posterior samples for each effect, where the posterior distribution is summarised by its mean and 95\\% highest density interval (HDI). The green text indicates the probability that the parameter values is either inferior or superior to 0."}
###############################################################
# Computing the effect of frequency for each letter and Grade #
###############################################################
